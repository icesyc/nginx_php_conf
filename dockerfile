...
#安装php
RUN yum install http://rpms.remirepo.net/enterprise/remi-release-7.rpm && yum-config-manager --enable remi-php74 && yum install php php-fpm php-mysql php-mbstring php-redis
